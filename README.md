...
The label implements `javax.swing.Scrollable` interface to support scrolling. By default, up to 20 text lines will be displayed without vertical scroll bar. 
